  ...
  <div class="app-container">
    <el-form ref="form" :model="form" :rules="rules" label-position="left" label-width="150px" class="my-form">
      ...
      <el-form-item label="serviceName">
        <el-input v-model="form.base.serviceName" placeholder="serviceName"></el-input>
      </el-form-item>
      <el-form-item label="pvcTemplates">
        <div v-for="(item,index) in form.base.volumeClaimTemplates" class="volume-class">
          <el-row>
            <el-col :span="10">
            ...
            <el-col :span="10">
              <el-col :span="3" style="text-align: center">
                <el-button style="height: 40px;margin-left: 10px"
                           @click="form.base.volumeClaimTemplates.splice(index,1)"
                           size="small"
                           type="danger">
                  delete
                  <i class="el-icon-delete"></i>
          ...
          <el-row>
            <el-form-item label="labels">
              <el-row v-for="(item_x,index_x) in item.labels" class="for-item">
                <el-col :span="10" style="padding-right: 5px">
                  <el-input v-model="item_x.key" placeholder="label key"></el-input>
                </el-col>
                <el-col :span="1" style="text-align: center">-</el-col>
                <el-col :span="10">
                  <el-input v-model="item_x.value" placeholder="label value"></el-input>
                </el-col>
                <el-col :span="3" style="text-align: center">
                  <el-button @click="item.labels.splice(index_x,1)"
                             size="small"
                             type="danger">
                    delete
                    <i class="el-icon-delete"></i>
              ...
              <el-button @click="addPvcTemplateLabels(index)"
                         size="small"
                         type="primary">
                add label
                <i class="el-icon-circle-plus"></i>
          ...
          <el-row>
            <el-form-item label="capacity">
              <el-input-number v-model="item.capacity"></el-input-number>
            </el-form-item>
          </el-row>
          <el-row>
            <el-form-item label="storageClassName">
              <el-select style="width: 50%" v-model="item.storageClassName">
                <el-option v-for="item_x in scOpts" :value="item_x.name" :label="item_x.name"/>
              </el-select>
            </el-form-item>
          </el-row>
          <el-row>
            <el-form-item label="accessModes">
              <el-select style="width: 50%" v-model="item.accessModes" multiple>
        ...
        <el-button @click="addPvcTemplate()"
                   size="small"
                   type="primary">
          add claimVolumeTemplate
          <i class="el-icon-circle-plus"></i>
        </el-button>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    addPvcTemplateLabels(index) {
      if (this.form.base.volumeClaimTemplates[index].labels == null) {
        this.form.base.volumeClaimTemplates[index].labels = []
      }
      this.form.base.volumeClaimTemplates[index].labels.push({})
    },
    addPvcTemplate() {
      this.form.base.volumeClaimTemplates.push({
        name: "",
        labels: [],
        capacity: 0,
        storageClassName: "",
    ...
    onSubmit(formName) {
      this.$refs[formName].validate((valid) => {
        ...
        this.$store.dispatch("statefulset/createStatefulSet", this.form).then(response => {
