  ...
  <div class="app-container">
    <div class="data-operation">
      ...
      <div class="data-operation-item">
        <el-button type="primary" @click="redirectTo('/discovery/ingress-edit')">新增</el-button>
      </div>
    </div>
    <el-table :data="list">
      ...
      <el-table-column label="hosts" width="150" prop="hosts" />
  ...
  methods: {
    doDel(name) {
      ...
      this.$confirm('此操作将永久删除该Ingress, 是否继续?', '提示', {
        ...
        this.$store.dispatch("ingress/deleteIngress", params).then(res => {
