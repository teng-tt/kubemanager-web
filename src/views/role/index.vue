  ...
  <div class="app-container">
    <div class="data-operation">
      ...
      <div class="data-operation-item">
        <el-button type="primary" @click="redirectTo('/rbac/role-edit')">新增</el-button>
      </div>
    </div>
    <div style="margin: 1rem 0">
      <el-switch v-model="isCluster">
      </el-switch>
    </div>
    <el-table :data="list">
      ...
      <el-table-column label="name" width="350" prop="name"/>
...
export default {
  ...
  methods: {
    ...
    goEdit(name) {
      this.redirectTo("/rbac/role-edit?name=" + name)
    },
    redirectTo(url) {
      this.$router.push(
        {
