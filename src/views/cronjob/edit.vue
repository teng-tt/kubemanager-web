  ...
  <div class="app-container">
    <el-form ref="form" :model="form" :rules="rules" label-position="left" label-width="150px" class="my-form">
      <el-form-item label="name" prop="base.name">
        <el-input v-model="form.base.name" placeholder="name"></el-input>
      </el-form-item>
      <el-form-item label="schedule" prop="base.name">
        <el-input v-model="form.base.schedule" placeholder="schedule"></el-input>
      </el-form-item>
      <el-form-item label="concurrencyPolicy">
        <el-select v-model="form.base.concurrencyPolicy" placeholder="concurrencyPolicy">
          <el-option value="Allow" label="Allow"></el-option>
          <el-option value="Forbid" label="Forbid"></el-option>
          <el-option value="Replace" label="Replace"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label-width="120px" label="suspend">
        <el-switch v-model="form.base.suspend"></el-switch>
      </el-form-item>
      <el-form-item label="successfulJobsHistoryLimit">
        <el-input-number style="margin-left: 3rem" v-model="form.base.successfulJobsHistoryLimit"
                         placeholder="successfulJobsHistoryLimit"/>
      </el-form-item>
      <el-form-item label="failedJobsHistoryLimit">
        <el-input-number style="margin-left: 3rem" v-model="form.base.failedJobsHistoryLimit"
                         placeholder="failedJobsHistoryLimit"/>
      </el-form-item>
      ...
      <el-form-item label="jobTemplate">
        <el-form-item label="backoffLimit">
          <el-input-number style="margin-left: 3rem" v-model="form.base.jobBase.backoffLimit"
                           placeholder="backoffLimit"/>
        </el-form-item>
        <el-form-item label="completions">
          <el-input-number style="margin-left: 3rem" v-model="form.base.jobBase.completions"
  ...
  methods: {
    ...
    onSubmit(formName) {
      this.$refs[formName].validate((valid) => {
        ...
        this.$store.dispatch("cronjob/createCronJob", this.form).then(response => {
