  ...
  <div class="app-container">
    <div class="data-operation">
      ...
      <div class="data-operation-item">
        <el-button type="primary" @click="redirectTo('/volume/pvc-edit')">新增</el-button>
      </div>
    </div>
    <el-table :data="list">
      ...
      <el-table-column label="volume" width="120" prop="volume"></el-table-column>
...
export default {
  ...
  methods: {
    getPVCList() {
      ...
      this.$store.dispatch("pvc/getPVCList", params).then(res => {
        this.list = res.data
      })
    },
    doDel(name) {
      ...
      this.$confirm('此操作将永久删除该PersistentVolumeClaim, 是否继续?', '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(() => {
        this.$store.dispatch("pvc/deletePVC", params).then(res => {
